...
@endphp
    ...
    <div class="element-100 mt-40 bg-light p-20 generic-wrapp">
        ...
        <div class="w-100 d-f jc-sb generic-main-type">

            <div class="w-50 expand-mobile">
                <div class="ac-stat-row d-f jc-sb ai-e">
                    <div class="ac-stat-name">Liczba treningów:</div>
                    <div class="ac-stat-line"></div>
                    <div class="ac-stat-value">{{ $general['count'] }}</div>
                </div>
                <div class="ac-stat-row d-f jc-sb ai-e">
                    <div class="ac-stat-name">Łączna wartość treningów:</div>
                    <div class="ac-stat-line"></div>
                    <div class="ac-stat-value">{{ $general['value'] . $label[1] }} </div>
                </div>

                <div class="ac-stat-row d-f jc-sb ai-e">
                    <div class="ac-stat-name">Średnia wartość treningów:</div>
                    <div class="ac-stat-line"></div>
                    <div class="ac-stat-value">{{ $general['avg_value'] . $label[1] }} </div>
                </div>

                <div class="ac-stat-row d-f jc-sb ai-e">
                    <div class="ac-stat-name">Łączny czas treningów:</div>
                    <div class="ac-stat-line"></div>
                    <div class="ac-stat-value">{{ $general['time'] }}</div>
                </div>

                <div class="ac-stat-row d-f jc-sb ai-e">
                    <div class="ac-stat-name">Średni czas treningów:</div>
                    <div class="ac-stat-line"></div>
                    <div class="ac-stat-value">{{ $general['avg_time'] }}</div>
                </div>
            ...
            <div class="w-50">
                <div>
                    <div class="ac_type_icon d-f jc-c ai-c large">
                        <span class="material-icon"> {{ $label[0] }} </span>
                    </div>
                    <div class="generic-title">{{ $ac->name }}</div>
                </div>
        ...
        <div class="w-100 d-f jc-c ai-c wrap relative mt-0">
            ...
            <div id="chart-all-ac-timeline" data-acType="{{ $ac->id }}" class="chart-container w-100 mt-50">
                <div class="load"></div>
        ...
        <div class="w-100">
            ...
            <div class="w-100 footwer-ranking d-f ai-e jc-c mt-50">
                ...
                <div class="footwear-second footwear-podium">
                    <div class="footwear-box-info">
                        @if(isset($footwear[1]))
                        <div>
                            <div class="footwear-img">
                                <img src="{{ asset('storage/footwear_images/'. $footwear[0]->model->image) }}" alt="" loading="lazy">
                            </div>
                        </div>
                        <div class="text-center">{{ $footwear[0]->model->name . '|' . $footwear[0]->model->model  }} </div>
                        @else
                        <div>
                    ...
                    <div class="footwear-box-holder">
                        <div class="material-button">2</div>
                    </div>
                    <div class="p-10 d-f jc-c ai-c">Treningi:  </div>
                </div>

                <div class="footwear-first footwear-podium">
                    <div class="footwear-box-info">
                        @if(isset($footwear[0]))
                        <div>
                            <div class="footwear-img">
                    ...
                    <div class="footwear-box-holder">
                        <div class="material-button">1</div>
                    </div>
                    <div class="p-10 d-f jc-c ai-c">Treningi:  </div>
                </div>

                <div class="footwear-third footwear-podium">
                    <div class="footwear-box-info">
                        @if(isset($footwear[3]))
                        <div>
                            <div class="footwear-img">
                    ...
                    <div class="footwear-box-holder">
                        <div class="material-button">3</div>
                    </div>
                    <div class="p-10 d-f jc-c ai-c">Treningi:  </div>
                </div>
            ...
            @else
                <div class="p-40 w-100 text-center">
